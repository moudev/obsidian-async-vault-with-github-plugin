const labels = {
  ...
  settingsInputPlaceholder: "Repository https url",
  settingsInputDescription: "Public or private. You must to have permissions in this repository. Example: https://github.com/username/vault-backup.git",
